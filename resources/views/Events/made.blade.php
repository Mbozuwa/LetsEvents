...
@foreach ($userEvents as $event)
                    ...
                    <div class="flex-center position-ref full-height">
                        ...
                        <div style="background-color: white;">
                          ...
                          <!-- <p>Catagories:<a href="/events/categories/{{$event->id}}">Klik hier</a></p> -->                             <a href="/events/edit/{{$event->id}}"><button style="margin-top: 40px;" class="btn bg-success btn-lg"><i class="far fa-edit" style="color:white;"></i></button></a>
